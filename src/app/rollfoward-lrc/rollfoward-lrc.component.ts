...
@Component({
  selector: 'app-rollfoward-lrc',
  templateUrl: './rollfoward-lrc.component.html',
  styleUrls: ['./rollfoward-lrc.component.scss']
})
export class RollfowardLrcComponent implements OnInit {
// lrcgroups:any;
public page=1;
public pageSize = 10;
lrcgroups:Array<any>;
...
lrc_executed(){
  ...
  calculateAll_lrc(){
    ...
    let sd=localStorage.getItem('sd')
      ...
      this.createProjectService.lrc_all_groups_execution(id,vd,sd).subscribe({next:result=>{
        console.log(result)
        this.hideSpinner5()
        this.lrc_executed()
        this.clicked=false
