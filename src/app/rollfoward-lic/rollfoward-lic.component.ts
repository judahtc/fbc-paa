...
@Component({
  selector: 'app-rollfoward-lic',
  templateUrl: './rollfoward-lic.component.html',
  styleUrls: ['./rollfoward-lic.component.scss']
})
export class RollfowardLicComponent implements OnInit {
public page=1;
public pageSize = 10;
licgroups:Array<any>;
  error: any=null;
  ...
  calculateAll_lic(){
    ...
    let sd=localStorage.getItem('sd')
      ...
      this.createProjectService.lic_all_groups_execution(id,vd,sd).subscribe({next:result=>{
        console.log(result)
        this.hideSpinner5()
        // this.lic_filenames()
