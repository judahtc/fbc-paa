...
@Component({
  selector: 'app-viewfiles-lc',
  templateUrl: './viewfiles-lc.component.html',
  styleUrls: ['./viewfiles-lc.component.scss']
})
export class ViewfilesLcComponent implements OnInit {
